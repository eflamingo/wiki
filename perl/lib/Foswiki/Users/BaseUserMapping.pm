...
sub new {
    ...
    $DEFAULT_USER_CUID = $Foswiki::cfg{DefaultUserKey};
    $UNKNOWN_USER_CUID = $Foswiki::cfg{DefaultUserKey};
    %BASE_USERS        = (
		# BaseUserMapping_333
        $Foswiki::cfg{AdminUserKey} => { 
    ...
    $Foswiki::cfg{Register}{RegistrationAgentWikiName} ||= $Foswiki::cfg{AdminUserWikiName};
