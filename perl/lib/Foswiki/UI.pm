...
# TODO: need to figure out how to get rid of these
    $Foswiki::cfg{SwitchBoard}{sip} = {
        package  => 'Foswiki::UI::Sip',
        function => 'sip',
        context  => { POST => 1 }, #what is search?
    };
    $Foswiki::cfg{SwitchBoard}{handleemail} = {
        package  => 'Foswiki::UI::HandleEmail',
        function => 'handleemail',
        context  => { handleemail => 1 },
        allow    => { POST => 1, GET => 1 }
    };
