...
sub _action_createNewGroup {
    my $session = shift;

    require Foswiki::UI::Register;
    Foswiki::UI::Register::createNewGroup($session);
}
...
sub _action_changeGroupMemberShip {
    my $session = shift;

    require Foswiki::UI::Register;
    Foswiki::UI::Register::changeGroupMemberShip($session);
}
...
sub _action_createweb {
    ...
    # thanks to the store, the full Wiki Name is returned, including the web. ie Main.JoeSmith
