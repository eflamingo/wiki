...
my $PART1 = time();
	...
	# some weird stuff happens when looking up the template
	my $fubar_query_param = $query->param('template'); 

		# this query param is fubar, nothing will display on 'view'
		# i have no idea why
	#$fubar_query_param = undef;
	# TODO: too lazy to do it the proper way
 	my $template_hash = {"addform.tmpl" => 1,"changes.tmpl" => 1,"formtables.tmpl" => 1,"moveattachment.tmpl" => 1,"preview.pattern.tmpl" => 1,"renamewebbase.pattern.tmpl" => 1,"settings.tmpl" => 1,"viewsidebar.pattern.tmpl" => 1,"attachagain.pattern.tmpl" => 1,"comments.tmpl" => 1,"form.tmpl" => 1,"newsletter.tmpl" => 1,"preview.tmpl" => 1,"renamewebbase.tmpl" => 1,"twiki.tmpl" => 1,"viewslideshow.pattern.tmpl" => 1,"attachagain.tmpl" => 1,"compareinterweave.tmpl" => 1,"foswiki.pattern.tmpl" => 1,"oopsaccessdenied.tmpl" => 1,"rdiff.pattern.tmpl" => 1,"renamewebconfirm.tmpl" => 1,"twistyplugin.tmpl" => 1,"viewslideshow.tmpl" => 1,"attachnew.pattern.tmpl" => 1,"comparesidebyside.tmpl" => 1,"foswiki.tmpl" => 1,"oopsalertsnohtml.tmpl" => 1,"rdiff.tmpl" => 1,"renamewebdelete.tmpl" => 1,"validate.tmpl" => 1,"view.text.tmpl" => 1,"attachnew.tmpl" => 1,"compare.tmpl" => 1,"freeswitch.authorization.tmpl" => 1,"oopsalerts.tmpl" => 1,"registerconfirm.tmpl" => 1,"renameweb.tmpl" => 1,"viewbottombar.pattern.tmpl" => 1,"view.tmpl" => 1,"attach.pattern.tmpl" => 1,"cssmediatypes.tmpl" => 1,"icons.tmpl" => 1,"oopsattention.tmpl" => 1,"registerfailednotremoved.tmpl" => 1,"searchbase.pattern.tmpl" => 1,"view.famfamfam.tmpl" => 1,"viewtopbar.pattern.tmpl" => 1,"attachtables.pattern.tmpl" => 1,"css.pattern.tmpl" => 1,"login.pattern.tmpl" => 1,"oopschangelanguage.tmpl" => 1,"registerfailedremoved.tmpl" => 1,"searchbookview.pattern.tmpl" => 1,"view.pattern.tmpl" => 1,"viewtopicactionbuttons.tmpl" => 1,"attachtables.tmpl" => 1,"css.tmpl" => 1,"login.sudo.pattern.tmpl" => 1,"oopsgeneric.tmpl" => 1,"registernotifyadmin.tmpl" => 1,"searchbookview.tmpl" => 1,"viewplain.pattern.tmpl" => 1,"view.xml.tmpl" => 1,"attach.tmpl" => 1,"editform.pattern.tmpl" => 1,"login.sudo.tmpl" => 1,"oopshistory.tmpl" => 1,"registernotify.tmpl" => 1,"searchformat.pattern.tmpl" => 1,"view.plain.tmpl" => 1,"backlinksallwebs.tmpl" => 1,"editform.tmpl" => 1,"login.tmpl" => 1,"oopslanguagechanged.tmpl" => 1,"renameattachmentdelete.tmpl" => 1,"searchformat.tmpl" => 1,"viewplain.tmpl" => 1,"backlinks.tmpl" => 1,"edit.pattern.tmpl" => 1,"mailnotify.tmpl" => 1,"oopsleaseconflict.tmpl" => 1,"renamebase.pattern.tmpl" => 1,"searchmeta.tmpl" => 1,"viewprint.pattern.tmpl" => 1,"backlinksweb.tmpl" => 1,"edittext.tmpl" => 1,"mailresetpassword.tmpl" => 1,"oops.pattern.tmpl" => 1,"renamebase.tmpl" => 1,"search.pattern.tmpl" => 1,"view.print.tmpl" => 1,"changeform.pattern.tmpl" => 1,"edit.tmpl" => 1,"messages.tmpl" => 1,"oopsredirectdenied.tmpl" => 1,"renameconfirm.tmpl" => 1,"search.text.tmpl" => 1,"viewprint.tmpl" => 1,"changeform.tmpl" => 1,"form.pattern.tmpl" => 1,"more.tmpl" => 1,"oopssaveerr.tmpl" => 1,"renamedelete.tmpl" => 1,"search.tmpl" => 1,"view.rssatom.tmpl" => 1,"changes.pattern.tmpl" => 1,"formtables.pattern.tmpl" => 1,"moveattachment.pattern.tmpl" => 1,"oops.tmpl" => 1,"rename.tmpl" => 1,"settings.pattern.tmpl" => 1,"view.rss.tmpl" => 1};
	$fubar_query_param = undef unless $template_hash->{$fubar_query_param.'.tmpl'};
    my $template =
         $viewTemplate
      || $fubar_query_param
      || $session->{prefs}->getPreference('VIEW_TEMPLATE')
      || 'view';
    #my ($a1,$a2,$a3) = ($viewTemplate,$query->param('template'),$session->{prefs}->getPreference('VIEW_TEMPLATE'));
	#die "Template:($a1,$a2,$a3)" if $web eq 'Learn' && $topic eq 'MotherJones';
...
# after part 4 ............................................................................................
my $PART4 = time();
my ($PART5,$PART6,$PART7,$PARTA,$PARTB,$PARTC,$pekey,$pe2key);
...
$PART5 = time();
        ...
        # check cache for header_text
        my $cache_key = $template.'&'.$web.'&'.$topic.'&'.$session->{user};
        my $page_start = "";
        #$page_start = Foswiki::Func::fetchFromMemcached('render_cache','start'.$cache_key);
        if(!$page_start){
            $session->enterContext('header_text');
            $page_start = _prepare( $start, @args );
            $session->leaveContext('header_text');
            #Foswiki::Func::putInMemcached('render_cache','start'.$cache_key,$page_start,180);
        }
        else{
                #die "Start:\n\n$page_start";
        }
...
$PART7 = time();
        ...
        # check cache for footer_text
        my $page_end = "";
        #$page_end = Foswiki::Func::fetchFromMemcached('render_cache','end');
        my $dpageend = $page_end;
        if(!$page_end){
            $session->enterContext('footer_text');
            $page_end = _prepare( $end, @args );
            $session->leaveContext('footer_text');
            #Foswiki::Func::putInMemcached('render_cache','end',$page_end,180);
            #my $xpage_end = Foswiki::Func::fetchFromMemcached('render_cache','end');
            #die "why????($result)($page_end)($xpage_end)";
        }
        else{
           #die "success!($dpageend)";   
        }
...
my $LAST1 = time();
#die "0->1:(".$STARTTIME-$PART1.")\n1->2(".$PART2-$PART1.")\n2->FINISH:(".$LAST1-$PART2.")";
#die "$STARTTIME\n1:$PART1\n2:$PART2\n3:$PART3\n4:$PART4\n5:$PART5\n6:$PART6\nA:$PARTA\nB:$PARTB\nC:$PARTC\n7:$PART7\n8:$LAST1\n";
