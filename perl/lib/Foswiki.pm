...
#print STDERR "WARNING: Foswiki is using the compatibility logger. Please re-run configure and check your logfiles settings\n";
    ...
    ASSERT( !$@, $@ ) if DEBUG;
    #require Data::Dumper;
    #my $death = Data::Dumper::Dumper($Foswiki::cfg{Store}{Implementation});
    #die "Death:\n$death";
    ...
    #$topic = ucfirst($topic); # favio flamingo wants lower case first letters
...
sub innerExpandMacros {
    ...
    # push current context (what is this???? it appears to be null on every request)
