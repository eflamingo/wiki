...
var AMdelimiter2 = "$mathB$", AMescape2 = "\\\\\\$", AMdelimiter2regexp = "\\$";
  ...
  if (n.childNodes.length == 0) {
   if ((n.nodeType!=8 || linebreaks) &&
    ...
    if (!(str == null)) {
      ...
      str = str.replace(/\s*\r\n/g," ");
// DELIMITERS:
      mtch = (str.indexOf("\$math\$")==-1 ? false : true);
      str = str.replace(/([^\\])\$math\$/g,"$1 \$");
      str = str.replace(/^\$math\$/," \$");	// in case \$ at start of string
      arr = str.split(" \$");
